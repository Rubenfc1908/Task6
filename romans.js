...
function greaterThan9(num, mapping) {
    ...
    if (num >= 10 && num < 50) {
        ...
        for (var k = 0; k < parseInt(num / 10); k++) {
            result += mapping[10];
        }
        return result;
        ...
        result = mapping[50];
        for (var l = 0; l < parseInt((num - 50) / 10); l++) {
            result += mapping[10];
        }
        return result;
        ...
        for (var m = 0; m < parseInt(num / 100); m++) {
            result += mapping[100];
        }
        return result;
        ...
        result = mapping[500];
        for (var n = 0; n < parseInt((num - 500) / 100); n++) {
            result += mapping[100];
        }
        return result;
        ...
        for (var o = 0; o < parseInt(num / 1000); o++) {
            result += mapping[1000];
        }
        return result;
    }
